...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.hybrid_activity_main_advanced);
		mContext = this;
		if (!main_initialized) {
			this.new_init();
		}
	...
	private void new_init() {
		...
		int[] iconResourse = { R.drawable.hybrid_tbsweb, R.drawable.hybrid_fullscreen,
				R.drawable.hybrid_filechooser};
		...
		this.gridAdapter = new SimpleAdapter(this, items,
				R.layout.hybrid_function_block, new String[] { "title", "icon" },
